...
Route::group(['prefix' => '{languageSlug}', 'where' => ['languageSlug' => '[a-zA-Z]{2}']], static function () {
    ...
    Route::get('/brand/{slug}', [FrontProductModuleController::class, 'loadBrandPage'])->name('front.brands.show');
    Route::get('/category/{slug}', [FrontProductModuleController::class, 'loadCategoryPage'])->name('front.categories.show');
    Route::get('/product/{slug}', [FrontProductModuleController::class, 'loadProductPage'])->name('front.products.show');
});
