                    ...
                    @foreach($languages as $language)
                        ...
                        <div id="{{$language->code}}" class="tab-pane fade in @if($language->code === config('default.app.language.code')) active @endif">
                            ...
                            <div class="form-group @if($errors->has($langRegAddress)) has-error @endif">
                                ...
                                <input class="form-control" type="text" name="{{$langRegAddress}}" value="{{ old($langRegAddress) }}" required>
                ...
                <div class="form form-horizontal">
                    <div class="form-body">
                        <div class="form-group @if($errors->has('eik')) has-error @endif">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" name="eik" value="{{ old('eik') }}" required>
                            </div>
                            @if($errors->has('eik'))
                        ...
                        <div class="form-group @if($errors->has('vat_number')) has-error @endif">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" name="vat_number" value="{{ old('vat_number') }}" required>
                            </div>
                        ...
                        {{--                                    <input type="checkbox" name="active" class="success" data-size="small" {{ old('active') ? 'checked' :'' }}>--}}
